...
export const ACTIONS = {
  ...
  WORKSHOP_MARK_ATTENDANCE:   'workshop.mark_attendance',
  WORKSHOP_MARK_ALL_PRESENT:  'workshop.mark_all_present',
  WORKSHOP_ADD_WALK_IN:       'workshop.add_walk_in',
  WORKSHOP_RESEND_INVITE:     'workshop.resend_invite',
  WORKSHOP_CANCEL_REGISTRATION: 'workshop.cancel_registration',
