...
| 17. Workshop Lifecycle + Recording Pipeline | 1/6 | In Progress|  |
...
Plans:
- [ ] 17-00-PLAN.md — Wave 0 scaffolds: install groq-sdk, add GROQ_API_KEY to .env.example, create 4 RED test files
...
- [ ] 17-02-PLAN.md — src/lib/llm.ts Groq SDK wrapper with chatComplete/transcribeAudio/summarizeTranscript (LLM-01/02/03)
- [ ] 17-03-PLAN.md — workshopCompletedFn Inngest function: checklist creation + 72h/7d nudges (WS-12, WS-13)
- [ ] 17-04-PLAN.md — R2 recording category + workshopRecordingProcessedFn 4-step pipeline (WS-14)
