...
console.log(`Applying 0012 migration: ${statements.length} statements`)
...
// Sanity-check: SELECT is_public_draft FROM policy_documents LIMIT 1 should not throw.
