#!/usr/bin/env node
/**
 * Phase 20-01 — apply migration 0011_cal_com_workshop_register via Neon HTTP driver.
 *
...
const migrationPath = path.join(
  ...
  'db',
  'migrations',
  '0011_cal_com_workshop_register.sql',
)
...
console.log(`Applying 0011 migration: ${statements.length} statements`)
...
// Sanity-check: SELECT 1 FROM workshop_registrations LIMIT 1 should not throw.
const check = await sql.query('SELECT 1 FROM workshop_registrations LIMIT 1')
console.log('workshop_registrations probe ->', check)
