...
Reference full template: `D:/aditee/policydash/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/aditee/policydash/.claude/get-shit-done/templates/state.md`.
